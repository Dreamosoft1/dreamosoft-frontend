				...
				<div className="w-full mt-12 flex flex-col md:flex-row items-stretch justify-between gap-12">
					...
					<div className="w-full md:w-1/2 p-4 py-4 md:py-8">
						<div className="flex justify-center md:justify-start items-center gap-3">
							...
							<h3 className="text-[#177525] bg- my-4 font-bold text-xl">The ShuttleHub Project</h3>
							<span className="w-10 h-[3px] rounded-full bg-[#0AAB4A] mt-2"></span>
						</div>
						<p className="mt-4 text-center md:text-left md:mt-12">
						...
						<a href="" className="text-center md:text-left text-[#0021F5C9] hover:underline">
							Learn more...
						</a>
