...
const ServiceCard = ({ image, text }) => {
	return (
		<div className="w-full card rounded-[10px] bg-[#055987] flex pb-3 items-center justify-center flex-col h-40 md:h-64 relative overflow-hidden">
			...
			<h3 className="mt-auto text-white text-lg md:text-2xl font-bold text-center" dangerouslySetInnerHTML={{ __html: text }}></h3>
		</div>
	);
};
