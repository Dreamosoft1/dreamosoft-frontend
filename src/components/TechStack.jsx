...
const TechStack = () => {
	return (
		<div className="bg-white dark:bg-gray-900">
			{/* Tech Stack Section */}
			<section className="py-12 pt-24 bg-gray-50 dark:bg-gray-900 mt-1" data-aos="fade-up">
				<div className="max-w-screen-xl mx-auto text-center px-6">
					<h2 className="text-4xl font-bold text-section-heading dark:text-white mb-4">Tech Stack</h2>
					<p className="text-xs md:text-sm dark:text-gray-400 mb-10 w-[90%] md:w-[50%] mx-auto text-primary-1">
						Empowering Innovation: Discover the Cutting-Edge Tools and Technologies Driving Dreamsoft's Software Solutions
					</p>
