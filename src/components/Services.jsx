...
const Services = () => {
  return (
    <section
      className="w-full h-auto py-12 md:py-24 px-4"
      id="services"
      data-aos="fade-up"
    >
      <div className="w-full max-w-6xl mx-auto flex flex-col items-center justify-center">
        <h3 className="font-bold text-3xl text-section-heading mb-2 dark:text-white">
          Popular Services
        </h3>
        <div className="flex items-center justify-center gap-[6px] md:gap-3">
          ...
          <p className="text-[13px] text-center md:text-[16px] text-section-label">
            Experience our excellence through our services
          </p>
          <span className="w-8 md:w-20 h-[4px] rounded-full shadow-xl bg-section-label"></span>
        </div>
        ...
        <div className="w-full grid services grid-cols-4 md:grid-cols-6 mt-12 items-center gap-4 md:gap-24 justify-center">
          ...
          <ServiceCard
            text={"Machine <br/> Learning Projects"}
            image={MachineImage}
          />
        </div>
      </div>
